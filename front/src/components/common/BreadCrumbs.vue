<template>
  <el-breadcrumb class="app-breadcrumb" separator="☜☜☜" style="height:40px;backgroundColor:#FFE4E1;borderRadius:16px;padding:0px 20px 0px 600px;boxShadow:0px 0px 0px #f903d4;borderWidth:2px;borderStyle:none none dashed none ;borderColor:rgba(117, 113, 249, 1);">
