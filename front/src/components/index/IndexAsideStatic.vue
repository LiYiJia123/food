  ...
  <el-aside class="index-aside" height="100vh" width="200px">
    <div class="index-aside-inner menulist" style="height:100%">
      <div v-for="item in menuList" :key="item.roleName" v-if="role==item.roleName" class="menulist-item" style="height:100%;broder:0;background-color:#FFFFFF">
        ...
        <el-menu mode="vertical" :unique-opened="true" class="el-menu-demo" style="height:100%;" background-color="#FFE4E1" text-color="#000000" active-text-color="#A9A9A9" default-active="0">
...
<script>
//menus引用menuList引用item.backMenu引用了menu文件
      ...
      if("horizontal" === str) {
        this.$nextTick(()=>{
          document.querySelectorAll('.el-container .el-container').forEach(el=>{
            ...
            el.style.paddingTop = "40px" // header 高度
          })
