               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="客户姓名" prop="kehuName">
                       <el-input v-model="ruleForm.kehuName"
                                 placeholder="客户姓名" clearable  :readonly="ro.kehuName"></el-input>
                   </el-form-item>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="客户联系方式" prop="kehuPhone">
                       <el-input v-model="ruleForm.kehuPhone"
                                 placeholder="客户联系方式" clearable  :readonly="ro.kehuPhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="客户详情" prop="kehuOrderContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.kehuOrderContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.kehuOrderContent" label="客户详情" prop="kehuOrderContent">
                            <span v-html="ruleForm.kehuOrderContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
