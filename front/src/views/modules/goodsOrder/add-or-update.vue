        ...
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='kehu'">
                    <el-form-item class="select" v-if="type!='info'"  label="预定客户" prop="kehuId">
                ...
                <el-col :span="12"  v-if="sessionTable !='kehu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="客户联系方式" prop="kehuPhone">
                        <el-input v-model="kehuForm.kehuPhone"
                                  placeholder="客户联系方式" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="客户联系方式" prop="kehuPhone">
                            <el-input v-model="ruleForm.kehuPhone"
                                      placeholder="客户联系方式" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='kehu' ">
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="单号" prop="goodsOrderDanhaoNumber">
                       <el-input v-model="ruleForm.goodsOrderDanhaoNumber"
                                 placeholder="单号" clearable  :readonly="ro.goodsOrderDanhaoNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="单号" prop="goodsOrderDanhaoNumber">
                           <el-input v-model="ruleForm.goodsOrderDanhaoNumber"
                                     placeholder="单号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="预定数量" prop="goodsOrderNumber">
                       <el-input v-model="ruleForm.goodsOrderNumber"
                                 placeholder="预定数量" clearable  :readonly="ro.goodsOrderNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="预定数量" prop="goodsOrderNumber">
                           <el-input v-model="ruleForm.goodsOrderNumber"
                                     placeholder="预定数量" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="预定时间" prop="goodsOrderTime">
                        <el-date-picker
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.goodsOrderTime" label="预定时间" prop="goodsOrderTime">
                ...
                <el-col :span="12">
                    <div v-if="type=='info'">
                        <el-form-item class="input" label="预定状态" prop="goodsOrderValue">
                        <el-input v-model="ruleForm.goodsOrderValue"
                            placeholder="预定状态" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="备注" prop="goodsOrderContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.goodsOrderContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.goodsOrderContent" label="备注" prop="goodsOrderContent">
                            <span v-html="ruleForm.goodsOrderContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                ro:{
                    ...
                    kehuId: false,
                    yonghuId: false,
                    goodsOrderDanhaoNumber: false,
                    goodsOrderNumber: false,
                    goodsOrderTime: false,
                    goodsOrderTypes: false,
                    goodsOrderContent: false,
                },
                ruleForm: {
                    goodsId: '',
                    kehuId: '',
                    yonghuId: '',
                    goodsOrderDanhaoNumber: new Date().getTime(),
                    goodsOrderNumber: '',
                    goodsOrderTime: '',
                    goodsOrderTypes: '1',
                    goodsOrderContent: '',
                ...
                rules: {
                   ...
                   goodsOrderTypes: [
                              { required: true, message: '预定状态不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
