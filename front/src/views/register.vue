<template>
    <div style="backgroundImage: url('/shipinkucunguanli/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" >
                <h1 class="h1" style="color:#000;fontSize:28px;">食品库存管理系统注册</h1>
...
<style lang="scss" scoped>
    ...
    .container {
        ...
        background-image: url('../assets/beijin2.png');
